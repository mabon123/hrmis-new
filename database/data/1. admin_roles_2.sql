...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 02, 2022 at 09:08 AM
...
CREATE TABLE IF NOT EXISTS `admin_roles` (
  ...
  `role_kh` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `role_en` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role_slug` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(12, 'ប្រធានអង្គភាព', 'Leader', 'leader', 1),
(11, 'អ្នកគ្រប់គ្រងប្រព័ន្ធថ្នាក់កណ្តាល', 'Central Administrator', 'central-admin', 1);
COMMIT;
