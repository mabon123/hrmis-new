@php
	$morningHours = ['7:10 - 7:50', '7:50 - 8:30', '8:30 - 8:45', '8:45 - 9:25', '9:25 - 9:40', '9:40 - 10:20', '10:20 - 11:00'];
	$afternoonHours = ['1:00 - 1:40', '1:40 - 2:20', '2:20 - 2:35', '2:35 - 3:15', '3:15 - 3:30', '3:30 - 4:10', '4:10 - 4:50'];
@endphp

@foreach ($ahours as $h_index => $thour)
	<tr>
		...
		@else
			...
			@foreach ($tdays as $d_index => $tday)
				@if ($tday->day_id < 7)
					...
					@php $slot =  $afternoonTimetables[$h_index][$d_index]; @endphp

					@if ($h_index == 0 && $d_index == 3)
					...
					@elseif ($d_index != 3)
						<td>
							<select name="timetables[]" id="{{ $tid }}" 
			                    ...
			                    data-shift="{{ $grade_level == '13' ? 'a1' : 'a2' }}">
