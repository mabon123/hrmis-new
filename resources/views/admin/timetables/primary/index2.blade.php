...
@section('content')
    ...
    <section class="content">
        <!-- Search -->
        @include('admin.timetables.primary.filter2')
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h1 class="card-title" style="width:100%;text-align:center;">
                            ...
                            {{ __('timetables.grade_4_to_6') }}
                            {{ __('ឆ្នាំសិក្សា') . $curAcademicYear->year_kh }}
                            {{ __('(វេនព្រឹក)') }}
                        </h1>

                        <a href="{{ route('timetable.printPrimaryTimetable', [app()->getLocale(), '24']) }}" 
...
@push('scripts')
    <script type="text/javascript">
        $(function() {
            ...
            $("#timetable_primary_2 > a").addClass("active");
