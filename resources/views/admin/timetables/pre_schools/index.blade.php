...
@section('content')
    ...
    <section class="content">
        <!-- Search -->
        @include('admin.timetables.pre_schools.filter')
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h1 class="card-title" style="width:100%;text-align:center;">
                            ...
                            {{ __('(ថ្នាក់មត្តេយសិក្សា)') }}
                            {{ __('ឆ្នាំសិក្សា') . $curAcademicYear->year_kh }}
                        </h1>

                        <a href="{{ route('timetable.printPreTimetable', [app()->getLocale()]) }}" 
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-bordered table-striped table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                @include('admin.timetables.pre_schools.pre_dropdown')
                            </tbody>
                        </table>
                    </div>
...
@push('scripts')
    <script type="text/javascript">
        $(function() {
            ...
            $("#timetable_pre > a").addClass("active");
