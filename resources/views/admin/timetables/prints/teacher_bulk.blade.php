                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <h5 class="text-center profile-subtitle" style="margin-bottom:8px;font-size: 12px;">
                                    {{ __('កាលវិភាគគ្រូប្រចាំសប្តាហ៍ក្នុងឆ្នាំសិក្សា ') . $academicYear->year_kh }}
                                </h5>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-striped table-head-fixed text-nowrap" style="font-size: 11px" border="5" bordercolor="#000000">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" rowspan="2" style="vertical-align:middle;">{{ __('គោត្តនាម-នាម') }}</th>
                                                <th class="text-center" rowspan="2" style="vertical-align:middle;">{{ __('ភេទ') }}</th>
                                                @foreach ($tdays as $day)
                                                    <th class="text-center" colspan="10">{{ $day->day_kh }}</th>
                                                @endforeach
                                                <th class="text-center" colspan="3"style="vertical-align:middle;">{{ __('ចំនួនម៉ោង') }}</th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                @endforeach
                                                <th class="text-center" style="vertical-align:middle;">{{ __('បង្រៀន') }}</th>
                                                <th class="text-center" style="vertical-align:middle;">{{ __('កំណត់') }}</th>
                                                <th class="text-center" style="vertical-align:middle;">{{ __('បន្ថែម') }}</th>
                                            </tr>
                                        </thead>
                                        
                                        <tbody >
                                            @foreach ($staffs as $s_index => $staff)
                                                <tr style="font-size: 10px;">
                                                    <td class="text-center">{{ $s_index + 1 }}</td>
                                                    <td class="text-left">
                                                        {{ $staff->surname_kh.' '.$staff->name_kh }}
                                                    </td>
                                                    <td class="text-center">{{ $staff->sex == 1 ? 'ប' : 'ស' }}</td>

                                                    @php $totalHour = 0; @endphp
                                                    
                                                    @foreach ($tdays as $d_index => $tday)
                                                        @foreach ($thours as $h_index => $thour)
                                                            @php $timetableData = $timetables[$s_index][$d_index][$h_index]; @endphp

                                                            <td class="text-center" style="width:30px;padding-left:1px;padding-right:1px; font-size: 11px;">
                                                                @if (!empty($timetableData))
                                                                    @php $gradeKH = explode(' ', $timetableData->grade_kh); @endphp

                                                                    {{ $gradeKH[1].''.$timetableData->grade_name }}
                                                    ...
                                                    <td class="text-center">{{ $totalHour > 0 ? $totalHour : '' }}</td>
                                    ...
                                    <div class="row" style="margin-top:0px;">
                                        ...
                                        <div class="col align-self-center" style="margin-top:30px;">
                                            <p class="text-center">{{ __('បានឃើញ និងឯកភាព') }}</p>
                                            <p class="text-center">ថ្ងៃ.................ខែ.............ឆ្នាំ.............ព.ស ២៥.......</p>
                                            <p class="text-center">...........................,ថ្ងៃទី..........ខែ.............ឆ្នាំ...............</p>
                                            <h5 class="profile-ministry text-center" style="font-size:12px;">
                                            {{ __('ប្រធានមន្ទីរអប់រំ យុវជន និងកីឡាខេត្ត') }}
                                        </h5>
                                        </div>
