...
<head>
    ...
    <style>
        .profile-title{font-family:'Khmer OS Muol Light', Moul !important;width:100%;font-size:19px;margin-bottom:15px;}
        .profile-ministry{font-family:'Khmer OS Muol Light', Moul !important;width:100%;font-size:14px;margin-bottom:15px;}
        .profile-subtitle{font-family:'Khmer OS Muol Light', Moul !important;width:100%;font-size:14px;margin-bottom:20px;}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-body">
                            <div class="row">
                                <h5 class="text-center profile-title" style="margin-bottom:7x;">ព្រះរាជាណាចក្រកម្ពុជា</h5>
                                <h5 class="text-center profile-title" style="margin-bottom:7px;">ជាតិ សាសនា ព្រះមហាក្សត្រ</h5>
                            </div>

                            <div class="row">
                                <h5 class="profile-ministry" style="margin-bottom:7px;">{{ $userWorkplace->location_kh }}</h5>
                                <h5 class="" style="margin-bottom:8px;width:100%;font-size:15px;">
                                    {{ __('ថ្នាក់បង្រៀន៖ ') }}
                                    <strong>
                                        @foreach ($classToughts as $c_index => $classTought)
                                            @php $gradeKH = explode(' ', $classTought->grade_kh); @endphp

                                            {{ $gradeKH[1] .''. $classTought->grade_name }}
                                            {{ ($c_index < (count($classToughts) - 1)) ? ', ' : '' }}
                                        @endforeach
                                    </strong>
                                </h5>
                                <h5 class="" style="margin-bottom:8px;font-size:15px;">
                                    {{ __('កាន់បន្ទុក៖ ') }}
                                    @if (!empty($classIncharge))
                                        @php $gradeInchargeKH = explode(' ', $classIncharge->grade->grade_kh); @endphp
                                        <strong>{{ $gradeInchargeKH[1] .''. $classIncharge->grade_name }}</strong>
                                    @endif
                                </h5>
                            </div>
                            ...
                            <div class="row">
                                <h5 class="text-center profile-subtitle" style="margin-bottom:7px;">
                                    {{ __('កាលវិភាគគ្រូ ') . $staff->surname_kh . ' ' . $staff->name_kh }}
                                                ...
                                                <tr>
                                                    ...
                                                    @foreach ($timetables[$h_index] as $timetable)
                                                        <td class="kh">
                                                            @if ($timetable)
                                                                {{ 
                                                                    $timetable->tgrade->grade_id . ' ' . 
                                                                    $timetable->tgrade->grade_name . '(' . 
                                                                    $timetable->teacherSubject->subject->subject_shortcut.')'
                                                                }}
                                                            @endif
                                                        </td>
                                                    @endforeach
                            ...
                            <div class="row" style="margin-top:0px;margin-bottom:0px; ">
                                <div class="col align-self-start" style="margin-top: 5px;">
                                ...
                                <div class="col align-self-end" style="margin-bottom: 5px;">
                                   <!-- <p class="text-right">ថ្ងៃ.................ខែ.............ឆ្នាំ.............ព.ស ២៥.......</p>-->
                                    <p class="text-right">...........................,ថ្ងៃទី..........ខែ.............ឆ្នាំ...............</p>
                                    <h5 class="profile-ministry text-center" style="font-size:14px;">សាស្រ្តាចារ្យ</h5>
                                </div>
                            </div>
                        </div> <!-- /.card-body -->
                    </div>
