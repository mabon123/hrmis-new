...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>
                    <i class="fa fa-file"></i> {{ __('menu.tcp_assessment_teacher') }}
                </h1>
            </div>
                ...
                <div class="card-body custom-card">
                    <div class="tab-content">
                        <div class="tab-pane fade show active">
                            ...
                            {!! Form::open(['route' => ['tcp-assessment-teachers.store', [app()->getLocale()]], 'method' => 'POST', 'id' => 'frmCreateTCPAssessmentTeacher']) !!}

                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="pathway_cat_id">@lang('tcp.pathway_cat')</label>

                                            {{ Form::select('pathway_cat_id', ['' => __('common.choose').' ...'], null, ['id' => 'pathway_cat_id', 'class' => 'form-control select2 kh']) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="cat4_weighting">@lang('tcp.cat4_weighting')</label>

                                            {{ Form::text('cat4_weighting', null, ['id' => 'cat4_weighting', 'class' => 'form-control']) }}
                                        </div>
                                    </div>

                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="cat4_indicator_num">@lang('tcp.cat4_indicator_num')</label>

                                            {{ Form::number('cat4_indicator_num', null, ['id' => 'cat4_indicator_num', 'class' => 'form-control']) }}
                                        </div>
                                    </div>

                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="cat4_scoreby_indicator">@lang('tcp.cat4_scoreby_indicator')</label>

                                            {{ Form::text('cat4_scoreby_indicator', null, ['id' => 'cat4_scoreby_indicator', 'class' => 'form-control']) }}
                                        </div>
                                    </div>

                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="cat4_maxscore_sub">@lang('tcp.cat4_maxscore_sub')</label>

                                            {{ Form::text('cat4_maxscore_sub', null, ['id' => 'cat4_maxscore_sub', 'class' => 'form-control']) }}
                                        </div>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $("#tcp_assessment_teacher > a").addClass("active");

            // Validation
            /*$("#frmCreateTCPAssessmentTeacher").validate({
                rules: {
