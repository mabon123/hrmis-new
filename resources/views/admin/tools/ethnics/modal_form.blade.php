<div class="modal fade" id="modal-form">
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content rounded-0">
			{!! Form::open(['route' => ['ethnics.store', app()->getLocale()], 'method' => 'post', 'id' => 'frmNewRecord']) !!}
				<div class="modal-header">
					<h4 class="modal-title">{{ __('common.create_ethnic') }}</h4>
					...
					<div class="row">
						<div class="col-md-12">
	                        <div class="form-group">
	                            <label for="ethnic_kh">{{ __('common.ethnic_kh') }} 
	                            	<span class="required">*</span></label>
	                            {{ Form::text('ethnic_kh', null, 
	                            	['id' => 'ethnic_kh', 'class' => 'form-control kh', 'maxlength' => 50, 
	                    ...
	                    <div class="col-md-12">
	                        <div class="form-group">
	                            ...
	                            {{ Form::text('ethnic_en', null, 
	                            	['id' => 'ethnic_en', 'class' => 'form-control', 'maxlength' => 30, 
	                            		'autocomplete' => 'off']) }}
	                        </div>
	                    </div>
					</div>
