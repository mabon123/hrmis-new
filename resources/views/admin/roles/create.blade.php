        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('login.create_role') }}</li>
                </ol>
...
<section class="content">
    ...
    <form method="post" id="frmCreateRole" action="{{ route('roles.store', [app()->getLocale()]) }}">
        @csrf

        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">{{ __('login.create_role') }}</h3>
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="role_kh" id="role_kh" maxlength="150" autocomplete="off" class="form-control kh">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="role_en" id="role_en" maxlength="50" autocomplete="off" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="role_slug" id="role_slug" maxlength="100" autocomplete="off" class="form-control @error('role_slug') is-invalid @enderror">
                        </div>
                    </div>
