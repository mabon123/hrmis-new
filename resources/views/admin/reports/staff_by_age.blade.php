...
<section class="content">
    <div class="row row-box">
        ...
        <div class="col-sm-6 text-right">
            <div class="btn-group">
                <a href="{{ route('reports.exportStaffbyAgePDF', 
                    [app()->getLocale(), $pro_code, $age_from, $age_to, $dis_code, $location_code]) }}" 
                    class="btn btn-sm btn-info" style="width:220px;" target="_blank">
                    <i class="fas fa-file-pdf"></i> {{ __('button.export_to_pdf') }}
                </a>
            </div>
            <div class="btn-group">
                <a href="{{ route('reports.exportStaffbyAgeExcel', 
                    [app()->getLocale(), $pro_code, $age_from, $age_to, $dis_code, $location_code]) }}" 
