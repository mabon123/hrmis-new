...
<head>
    ...
    <title>បញ្ជីរាយនាមមន្រ្តីរាជការស្នើសុំដំឡើងថ្នាក់តាមវេន{{auth()->user()->work_place->location_kh}}ឆ្នាំ{{$y}}</title>
                ...
                <tr>
                    <td colspan="15" style="border-left: none!important; border-top: none!important; border-right: none!important;">
                        <header>
                            ...
                            <h2>តាមវេនអតីតភាពការងារសម្រាប់ឆ្នាំ{{$y}}</h2>
                        </header>
                    </td>
                </tr>
                <tr>
