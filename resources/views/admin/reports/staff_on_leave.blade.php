...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="fa fa-file"></i> {{ __('menu.dashboard_leave_info') }} </h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('menu.dashboard_leave_info') }}</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ route('staffs.show', [app()->getLocale(), $staff->payroll_id]) }}" 
                                        ...
                                        <i class="far fa-eye"></i> {{ __('button.view') }}</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
