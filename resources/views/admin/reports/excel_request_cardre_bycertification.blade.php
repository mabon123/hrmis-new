...
<?php if($pro_code > 0) { ?>
    ...
    <h2>បញ្ជីរាយនាមមន្រ្តីរាជការស្នើសុំដំឡើងថ្នាក់ ឋានន្តរស័ក្ដិ តាមសញ្ញាបត្រខ្ពស់ជាងក្របខណ្ឌសម្រាប់ឆ្នាំ{{$y}}</h2>
    ...
    <table>	
        ...
        <tr><td colspan="15"><h3>១- ប្រកាស</h3></td></tr>
        <tr><td colspan="15"><h3>១-១ ដំឡើងថ្នាក់ </h3></td></tr>
            @if(count($brokah_domleungtnaks) > 0)
                @foreach($brokah_domleungtnaks as $index => $brokah_domleungtnak)
                    ...
                    <tr>
                        ...
                        <td nowrap>{{ $brokah_domleungtnak->surname_kh.' '.$brokah_domleungtnak->name_kh }}</td>
                ...
                @endforeach
            @endif
        <tr><td colspan="15"><h3>១-២ ឋានន្តរស័ក្ដិ  </h3></td></tr>
            @if(count($brokah_thanorns) > 0)
                @foreach($brokah_thanorns as $index => $brokah_thanorn)
                    ...
                    <tr>
                        ...
                        <td>{{ $brokah_thanorn->surname_kh.' '.$brokah_thanorn->name_kh }}</td>
                ...
                @endforeach
            @endif
        <tr><td colspan="15"><h3>២- អនុក្រឹត្យ</h3></td></tr>                    
        <tr><td colspan="15"><h3>២-១ ដំឡើងថ្នាក់ </h3></td></tr>
            @if(count($ahnukret_domleungtnaks) > 0)
                @foreach($ahnukret_domleungtnaks as $index => $ahnukret_domleungtnak)
                    ...
                    <tr>
                        ...
                        <td nowrap>{{ $ahnukret_domleungtnak->surname_kh.' '.$ahnukret_domleungtnak->name_kh }}</td>
                        ...
                        <th>{{ (!empty($ahnukret_domleungtnak->highestQualification->qualificationCode->qualification_kh)) ? ($ahnukret_domleungtnak->highestQualification->qualificationCode->qualification_kh) : '' }}</th>
                ...
                @endforeach
            @endif
        <tr><td colspan="15"><h3>២-២ ឋានន្តរស័ក្ដិ</h3></td></tr>
            @if(count($ahnukret_thanorns) > 0)
                @foreach($ahnukret_thanorns as $index => $ahnukret_thanorn)
                    ...
                    <tr>
                        ...
                        <td nowrap>{{ $ahnukret_thanorn->surname_kh.' '.$ahnukret_thanorn->name_kh }}</td>
                ...
                @endforeach
            @endif
        <tr><td colspan="15"><h3>៣- ព្រះរាជក្រឹត្យ</h3></td></tr>
        <tr><td colspan="15"><h3>៣-១ ដំឡើងថ្នាក់ </h3></td></tr>
            @if(count($reachkret_domleungtnaks) > 0)
                @foreach($reachkret_domleungtnaks as $index => $reachkret_domleungtnak)
                    ...
                    <tr>
                        ...
                        <td nowrap>{{ $reachkret_domleungtnak->surname_kh.' '.$reachkret_domleungtnak->name_kh }}</td>
                ...
                @endforeach
           @endif
        <tr><td colspan="15"><h3>៣-២ ឋានន្តរស័ក្ដិ</h3></td></tr>
            @if(count($reachkret_thanorns) > 0)
                @foreach($reachkret_thanorns as $index => $reachkret_thanorn)
                    ...
                    <tr>
                        ...
                        <td>
                            @if($reachkret_thanorn->lastCardre->cardre_type_id == 1 && $reachkret_thanorn->lastCardre->request_cardre_check_status == 1)               
                        ...
                        <td>{{ (!empty($reachkret_thanorn->requestCardreCertificate->salaryLevel) || !empty($reachkret_thanorn->requestCardreCertificate->salary_degree)) ? ($reachkret_thanorn->requestCardreCertificate->salaryLevel->salary_level_kh .'.'. $reachkret_thanorn->requestCardreCertificate->salary_degree) : '' }}</td>
                        <td>{{ (!empty($reachkret_thanorn->highestQualification->qualificationCode->qualification_kh)) ? ($reachkret_thanorn->highestQualification->qualificationCode->qualification_kh) : '' }}</td>
...
<?php }elseif($pro_code == 0 ) { ?>
    ...
    <table>	
        ...
        <tr><td><strong>បច្ចុប្បន្ន</strong></td><td><strong>ស្នើសុំ</strong></td></tr>
            ...
            <tr><td colspan="15" style="text-align: left;"><h3>{{$province->name_kh}}</h3></td></tr>
            <tr><td colspan="15"><h3>១- ប្រកាស</h3></td></tr>
            <tr><td colspan="15"><h3>១-១ ដំឡើងថ្នាក់ </h3></td></tr>
                @if(count($brokah_domleungtnaks) > 0)
                    @foreach($brokah_domleungtnaks as $index => $brokah_domleungtnak)                        
